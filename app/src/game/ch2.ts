...
const C2N1: Record<string, Step> = {
  ...
  c2n1_b5b: { speaker: 'kai', sprite: 'char_kai', text: "名片拿着，撤场后归片区同事管。有事先打电话。上回那台你敢拆，这台可别照着来，我也怕你拆出一箱多余螺丝。", next: 'c2n1_b6' },
  ...
  c2n1_m3a: { speaker: 'me', sprite: 'char_he', text: "先平扫看有没有出血。小何，机房准备好了，推过来吧。", card: 'plain_first', image: 'ct_head_hema', next: 'c2n1_m4' },
  c2n1_m3b: { speaker: 'zhou', sprite: 'char_zhou', text: "先别加项目。这位先做头颅平扫，我看完再说。申请单给我。", card: 'plain_first', image: 'ct_head_hema', next: 'c2n1_m4' },
  ...
  c2n1_m8: { speaker: 'zhou', sprite: 'char_zhou', text: "这一层看清了，骨头没叠在脑子上。刚才平片里遮着的地方，现在能分开看。", image: 'ct_head_hema', card: 'ct_tomography', next: 'c2n1_m9' },
  ...
  c2n1_p2a: { speaker: 'zhou', sprite: 'char_zhou', text: "行，先平扫。找石头通常不用先打对比剂，等它排进尿路，反倒可能挡着小石头。", card: 'stone_plain', next: 'c2n1_p3' },
  c2n1_p2b: { speaker: 'zhou', sprite: 'char_zhou', text: "找结石先平扫，不是项目越多越好。对比剂排到尿路里，也会很亮，容易挡住小石头。", card: 'stone_plain', next: 'c2n1_p3' },
  c2n1_p2c: { speaker: 'he', sprite: 'char_he', text: "止痛已经在处理了，原因还没找到呢。周老师看过申请单了，按平扫方案来。", card: 'stone_plain', next: 'c2n1_p3' },
  c2n1_p3: { speaker: 'sys', text: "平扫完成。老周沿着输尿管往下翻，在末端停住：**一颗约3mm的高密度小点，上游轻度扩张**。", sfx: 'xray', image: 'ct_kidney_stone', next: 'c2n1_p4' },
...
const C2D2: Record<string, Step> = {
  ...
  c2d2_1: { speaker: 'director', sprite: 'char_director', sfx: 'vox2_director', text: "年轻人，白班要快！队列交给你，急诊来了叫我。别光盯屏幕，门口那排人也盯着点。", effect: { flag: 'day_shift' }, queue: C2D2_QUEUE0, next: 'c2d2_2' },
  ...
  c2d2_t1: { speaker: 'sys', text: "联合扫描完成，图像传到工作站。值班医师拉过椅子逐层查看，电话另一头，抢救室还在等结果。", image: 'ct_abdomen_trauma', sfx: 'xray', queue: C2D2_QUEUE2, next: 'c2d2_t2' },
  ...
  c2d2_11: { bg: 'bg_ctcontrol_day', speaker: 'sys', text: "第四例，手腕摔伤的学生。老周调出腕部切面：「先试骨窗。别把骨头调成一团白。」", image: 'ct_wrist_simulated', next: 'c2d2_w2' },
  ...
  c2d2_n3: { speaker: 'luzhou', sprite: 'luzhou', text: "博士还没毕业呢。做低剂量重建，天天和噪声较劲。今天批了体模实验的机时——赶紧扫，下午病人一来我又得搬走。", next: 'c2d2_n4' },
  ...
  c2d2_n6: { speaker: 'luzhou', sprite: 'luzhou', text: "同一份数据，直接反投影有点糊；加上滤波，就是**FBP**。这边轮廓清楚多了。原理那本旧书第三、四页有，别让我现场推，我也得翻。", image: 'ct_phantom', next: 'c2d2_n7' },
  ...
  c2d2_n9: { speaker: 'luzhou', sprite: 'luzhou', text: "右边是**迭代重建**。先估一幅图，再跟采集数据反复对，慢慢修。噪声少些，但电脑得多干活——我等结果的时候都能泡碗面。", next: 'c2d2_n10' },
...
const C2N3: Record<string, Step> = {
  ...
  c2n3_m7a: { speaker: 'zhou', sprite: 'char_zhou', text: "这几层糊了，不能拿它排出血。先停一下，把头托和固定垫调整好，只补受影响的范围。", image: 'ct_motion', dnt: 29, next: 'c2n3_m8' },
  c2n3_m7b: { speaker: 'me', text: "先停一下，头托没放稳。小唐，帮我调整固定垫。（确认人员离开机房后，按医师意见补扫受影响的范围。）", dnt: 29, image: 'ct_motion', next: 'c2n3_m8' },
  ...
  c2n3_m9: { speaker: 'zhou', sprite: 'char_zhou', text: "平扫没看到明确出血。我把结果报给卒中团队，**用药由他们评估**。CTA的准备接上。", dnt: 38, image: 'ct_head_stroke', next: 'c2n3_m10' },
...
const C2D4: Record<string, Step> = {
  ...
  c2d4_e2: { speaker: 'zhou', sprite: 'char_zhou', sprite2: 'char_director', text: "先等等。「图像质量参数」具体是什么？把字段摊开看看，别等装完了才发现连病人姓名也传了。", next: 'c2d4_e3' },
  ...
  c2d4_e7a: { speaker: 'zhou', sprite: 'char_zhou', text: "小雷刚把姓名那一栏指给你看了。这个还传着，你让我怎么放心开？", next: 'c2d4_e8' },
  ...
  c2d4_e8: { speaker: 'sys', text: "散会时，陆舟的消息弹出来：「材料又退回来了，少一页导师签字。」你把输入框里的半句话删了，回了个「明天帮你问」。", effect: { flag: 'data_hook' }, next: 'c2d4_e9' },
...
const C2N5: Record<string, Step> = {
  ...
  c2n5_4: { speaker: 'zhou', sprite: 'char_zhou', text: "（递过门禁卡）你接夜班，我在值班室。有事打电话，别学小雷，净发一串感叹号。", next: 'c2n5_5' },
  ...
  c2n5_a7: { speaker: 'zhou', sprite: 'char_zhou', text: "（把登记册合上，压住你正要翻的手）……先收回去。柜门替我扶一下。", effect: { flag: 'old_register' }, event: 'ch2_cabinet', next: 'c2n5_a8' },
  ...
  c2n5_m7b: { speaker: 'me', sprite: 'pat_kiddad', text: "光盘给我，我调给值班医师看。今天新吐了两次，也得一起告诉他，不能只看三天前的图。", image: 'ct_head_child', next: 'c2n5_m8' },
  ...
  c2n5_m17: { speaker: 'sys', text: "扫描完成，值班医师对照旧片：未见新发颅内出血。急诊继续查呕吐原因，安排孩子留观。你把结果传了过去。", sfx: 'xray', image: 'ct_head_child_followup', next: 'c2n5_m18' },
  ...
  c2n5_n5: { speaker: 'me', text: "（夹着电话找毯子）有，有保暖毯。机房温度我也查一下。先别让大爷对着风口坐。", next: 'c2n5_r0' },
  // —— 事件2·续：体模上的年轮 ——
  ...
  c2n5_r2c: { speaker: 'sys', text: "你先报修，再打开用户端日志：**第217号通道反复报警**。截图发过去，工程师很快回复：「收到了，我带检测工具来，机柜先别拆。」", image: 'item_toolbox', card: 'ring_artifact', effect: { skill: 2, badge: 'wrench_night' }, next: 'c2n5_r3' },
  ...
  c2n5_g3: { speaker: 'zhou', sprite: 'char_zhou', text: "（摆摆手）别整那些。杯子洗过了，茶叶在值班室上层柜子。你上次找半天，翻的是下层。", next: 'c2n5_g4' },
