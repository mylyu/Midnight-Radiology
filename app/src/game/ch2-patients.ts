...
export const CH2_PATIENT_ENTRANCES = [
 {id:'fall',step:'c2n1_m0',sprite:'ch2_patient_fall_bed',voice:'vox_ch2_fall'},
 {id:'stone',step:'c2n1_pain',sprite:'pat_stone',voice:'vox_guy'},
 {id:'lung',step:'c2d2_3',sprite:'pat_uncle2',voice:'vox_ch2_lung'},
 {id:'gut',step:'c2d2_8',sprite:'ch2_patient_gut_bed',voice:'vox_ch2_gut'},
 {id:'waiting',step:'c2d2_q0',sprite:'ch2_patient_waiting_elder',voice:'vox_ch2_waiting'},
 {id:'postop',step:'c2d2_q1a',sprite:'ch2_patient_postop_bed',voice:'vox_ch2_postop'},
 {id:'trauma',step:'c2d2_t0',sprite:'ch2_patient_trauma_bed',voice:'vox_ch2_trauma'},
 {id:'wrist',step:'c2d2_11',sprite:'ch2_patient_wrist_student',voice:'vox_ch2_wrist'},
 {id:'stroke',step:'c2n3_m2',sprite:'ch2_patient_stroke_bed',voice:'vox_ch2_stroke'},
 {id:'chest',step:'c2n3_h0',sprite:'ch2_patient_chest_bed',voice:'vox_ch2_chest'},
 {id:'mystery',step:'c2n3_x1',sprite:'pat_mystery',voice:'vox2_mystery'},
 {id:'aorta',step:'c2d4_2',sprite:'ch2_patient_aorta_bed',voice:'vox_ch2_aorta'},
 {id:'denture',step:'c2d4_11a',sprite:'pat_grandpa2',voice:'vox_ch2_denture'},
...
stage('ch2_patient_gut_bed',['c2d2_9a','c2d2_9b'])
stage('ch2_patient_waiting_elder',['c2d2_q1b','c2d2_q1c'])
stage('ch2_patient_stroke_bed',['c2n3_m3','c2n3_m4'])
stage('ch2_patient_chest_bed',['c2n3_h1','c2n3_h2','c2n3_h3a','c2n3_h3b','c2n3_h3c'])
stage('ch2_patient_aorta_bed',['c2d4_3','c2d4_4','c2d4_5','c2d4_6','c2d4_7','c2d4_8'])
stage('pat_grandpa2',['c2d4_m2'])

const lines: Record<string,string> = {
 c2d2_3:'大爷拍拍旧片袋：「上回的片子，我都带来了。」',
 c2d2_8:'平车停下来，小伙子攥着腹部的衣服：「哎哟……肚子疼死了。」',
 c2d2_q0:'大爷又探过头：「哎，到我没有啊？」',
 c2d2_q1a:'电梯门一开，术后复查的病人躺在平车上，低声说：「慢一点，伤口有点疼。」',
 c2d2_11:'学生托着伤腕：「嘶……这只手真不敢动。」',
 c2n3_h0:'他躺在平车上，断断续续挤出几个字：「胸口……闷得慌。」',
 c2d4_2:'床上的病人低低呻吟：「呃……背也疼……」',
 c2d4_11a:'他揉了揉额角：「哎，这头疼好几天了。」',
}
...
export function patientStep(id:string, step:Step):Step {
 ...
 if (id==='c2d2_9b') { next.sfx=undefined; next.sprite='ch2_patient_gut_bed'; next.text=next.text?.replace('蜷在椅子上','蜷在平车上') }
 return next
}
