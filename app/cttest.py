...
with sync_playwright() as pw:
    ...
    boot(pg, mk('n3_s16',3)); pg.mouse.click(640,500); pg.wait_for_timeout(2600)
    t=pg.locator('body').inner_text()
    print('新设定(球管烧了):', '球管烧了' in t, '| 旧设定残留:', '空了两年' in t)
    # 尾声预告图
    boot(pg, mk('n5_epi10',5)); pg.mouse.click(640,500); pg.wait_for_timeout(3000)
    pg.mouse.click(640,500); pg.wait_for_timeout(3000)
    t=pg.locator('body').inner_text()
    print('预告新文案:', '黑了大半年的CT室' in t)
