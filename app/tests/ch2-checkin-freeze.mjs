...
assert.deepEqual(additions('app/src'), CHECKIN_ADDED_FILES, 'Only three isolated check-in source files may be added')
assert.deepEqual(additions('app/public/assets'), [], 'Check-in adds no image assets')
