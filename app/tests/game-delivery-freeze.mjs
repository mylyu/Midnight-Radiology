...
assert.deepEqual(priorDayCasesMediaPaths(additions('app/public/assets')), deliveryAddedMedia(), 'Only the 194 precisely reviewed replacement paths after the independently pinned later wrist image')
